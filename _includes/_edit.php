...
if (!isset($_SESSION['user'])) $new_dropped_by = '[Anonymous]';
elseif (isset($new_cbAnonymous)) $new_dropped_by = '[Anonymous]';
else {
    $user = "{$_SESSION['email']}";
...
$sql="UPDATE notes SET title = '$new_title', content = '$new_content', dropped_by = '$new_dropped_by', dropped_for = '$new_dropped_for' WHERE id = $id";
mysqli_query($db, $sql);
