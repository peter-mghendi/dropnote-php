...
<div class="container my-4 index" >
    <div id="welcomeCard" class="container card mt-3 text-center">
        <div class="card-body">
    ...
    <div class="container card mt-3 tab-content" id="pills-tabContent">
        <div class="card-body tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="pills-info-tab">
            ...
            <p class="card-text">Behold, I bring you DropNote! (Are you beholding?) The tool you never knew you needed (because you probably don't). 
                    Okay, I did this as a joke. But hey, here we are, and here it is. Just one thing: don't make it a point listening 
                ...
                <p>Okay don't get me wrong, I did this as seriously as anything else (ummmm...), but it may contain bugs that slipped past
                    my notice (The ones that aren't intentional). Click <a href="https://www.github.com/l3njo/dropnote-web/issues"><i class="far fa-hand-point-right mr-2"></i>here<i class="far fa-hand-point-left ml-2"></i></a> to 
                    view the bugs I've already caught, report the ones I 
        ...
        <div class="card-body tab-pane fade" id="about" role="tabpanel" aria-labelledby="pills-about-tab">
            ...
            <p class="card-text">2. Any data you provide will not be shared with any third parties.</p>
            <p class="card-text">&copy <?=date("Y");?> !boop.  All rights reserved.</p>
        </div>
